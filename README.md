...
- **Environment variables editor**: a table view of a project's `.env`, one row per key/value, with masking and reveal for secret-looking keys, duplicate-key warnings, and a Raw mode for anything the table can't represent losslessly.
